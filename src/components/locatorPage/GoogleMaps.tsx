...
import Mapicon from "..//../images/mapi-pin.svg";
import newMapPin from "..//../images/newMapPin.svg";
...
//  console.log(userlat)
 ...
 let marker_icon = {
  ...
  let new_marker_icon = {
    ...
    /*path: "M18.942,56.14C2.965,32.568,0,30.149,0,21.486A21.3,21.3,0,0,1,21.111,0,21.3,21.3,0,0,1,42.222,21.486c0,8.663-2.965,11.082-18.942,34.654a2.614,2.614,0,0,1-4.339,0Zm2.17-25.7a8.954,8.954,0,1,0-8.8-8.953A8.875,8.875,0,0,0,21.111,30.439Z",*/
    url:newMapPin,
    fillColor: pinStyles.newStroke,
    scale: 1.1,
    fillOpacity: 1,
    strokeColor: pinStyles.newStroke,
    strokeWeight: 1,
    labelOrigin: new google.maps.Point(21,22),
  };
  ...
  for (const result of locationResults) {
    ...
    // console.log(markerLabel,"Marker Label");
  ...
  useEffect(() => {    
    ...
    gridHover(markerPins, marker_icon, new_marker_icon);
...
function addActiveGrid(index) {
  ...
  document.querySelectorAll(".location")[index].classList.add("active");
}
  ...
  function Infowindow(i:Number,result:any):void{      
     const MarkerContent=         
          ...
          <div className="addressData">{result.rawData.address.line1},{result.rawData.address.sublocality}</div>
          <div>{result.rawData.address.city}</div>
          </div>
          );
